...
def experiment(variant, bcq_policies, bcq_buffers, ensemble_params_list, prev_exp_state=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', default='halfcheetah-vel')
    ...
    for idx in idx_list:
        ...
        ensemble_params_list.extend(params['trainer']['network_ensemble_state_dict'])
    ...
    experiment(variant, bcq_policies, bcq_buffers, ensemble_params_list, prev_exp_state=None)

        ...
        for i in range(num_tasks):
            ...
            for j in range(num_tasks):
                ...
                if j != i:
                    ...
                    relabel_next_obs_all = relabeled_next_obs_mean[i, j*num_trans_context : (j+1)*num_trans_context]
                    # relabel_next_obs_all: (num_selected, obs_dim)
                    relabel_next_obs_selected = relabel_next_obs_all[mask_for_task_j]
                    ...
                    context_trans_selected_relabel = torch.cat([
                        ...
                        relabel_next_obs_selected, 
                        relabel_reward_selected
                    ], dim=1)

...
variant = dict(
    ...
    base_log_dir='./data_triplet_margin_4p0',
)

assert variant['triplet_margin'] == 4.0
assert variant['std_threshold'] == 0.1
assert num_tasks == 10
assert variant['is_combine'] == True

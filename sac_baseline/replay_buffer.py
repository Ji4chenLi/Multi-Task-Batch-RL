...
class ReplayBuffer(object):
    ...
    def __init__(
        ...
        ob_dim = ob_space.low.size
        ac_dim = action_space.low.size
    ...
    def reset(self):
        ob_dim = self._ob_space.low.size
        ac_dim = self._action_space.low.size

        self._observations = np.zeros((self._max_replay_buffer_size, ob_dim))
        self._next_obs = np.zeros((self._max_replay_buffer_size, ob_dim))
        self._actions = np.zeros((self._max_replay_buffer_size, ac_dim))
